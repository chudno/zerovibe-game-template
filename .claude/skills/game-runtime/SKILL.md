...
content/<kit>.json           тексты, исходы, уровни и сюжет китов (quiz, persona, wheel, levels, novel, quest, memory, clicker, sort, match3)
...
`title`, `archetype` (runner|catch|quiz|persona|wheel|platformer|novel|quest|memory|clicker|sort|match3),

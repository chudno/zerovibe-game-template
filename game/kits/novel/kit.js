...
(function (global) {
  ...
  // Реплика напечатана: показать варианты, кнопку мини-игры или «дальше».
  ...
  function finish(scene) {
    ...
    global.ZV.finish(scene, {
      ...
      outcome: end.outcome,
      meta: { archetype: "novel", ending: end.outcome, steps: scene.rt.history.length, vars: scene.rt.vars, plays: scene.plays }
    });
  }
